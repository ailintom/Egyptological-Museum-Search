...
<!DOCTYPE HTML PUBLIC '-//W3C//DTD HTML 4.01//EN' 'http://www.w3.org/TR/html4/strict.dtd'><html><head><meta name="viewport" content="width=device-width, initial-scale=1.0"><?php
        ...
        ?>
            ...
            You can also try the <a href="javascript:void%20function(){function%20a(b,c){var%20d=document.createElement(%22a%22);d.style.display=%22none%22,h.appendChild(d),c%3Fd.target=%22_blank%22:d.setAttribute(%22download%22,%22download.jpg%22),d.href=b,d.click(),h.removeChild(d)}function%20c(b,c,d,e,f){var%20g=c,h=new%20Set(b.match(g));[...h].forEach(function(b,c){setTimeout(function(){var%20c=g.exec(b);g.lastIndex=0,a(d+c[1].replace(/%26amp;/g,%22%26%22)+e,f)},120*(c+1))})}var%20d,e,f,g=window.location.href,h=document.body;if(/britishmuseum\.org/.test(g)){var%20b=/\/mid_(\d*)_(\d*).jpg/gm,j=new%20Set(h.innerHTML.match(b));[...j].forEach(function(c,e){setTimeout(function(){d=b.exec(c),b.lastIndex=0,a(%22/api/_image-download%3Fid=%22+%20+d[1].concat(d[2]),0)},120*(e+1))})}else%20if(/brooklynmuseum\.org/.test(g))c(h.innerHTML,/data-full-img-url=%22(.*)%22/gm,%22%22,%22%22,!0);else%20if(/mfa\.org/.test(g)){var%20b=/(\/internal.*%3F3Aformat%253D)postage/gm;b.test(h.innerHTML)%3Fc(h.innerHTML,b,%22%22,%22full%22,0):a(document.getElementsByName(%22og:image%22)[0].getAttribute(%22content%22),0)}else%20if(/louvre\.fr/.test(g))c(h.innerHTML,/data-api-dl=%22(.*%3F)%22/gm,%22%22,%22%22,0);else%20if(/rmo\.nl/.test(g))c(h.innerHTML,/(\/imageproxy\/jpg\/.*%3F)%22/gm,%22%22,%22%22,0);else%20if(/petriecat\.museums\.ucl\.ac\.uk/.test(g)){var%20k=/maxphotos=(\d*)/gm.exec(h.innerHTML)[1];if(d=/object_images\/mid(\/.*%3F)1.jpg%22/gm.exec(h.innerHTML),1==k||null===d)c(h.innerHTML,/object_images\/mid(\/.*%3F.jpg)%22/gm,%22/object_images/full%22,%22%22);else%20for(e=1;e%3C=k;e+=1)a(%22/object_images/full%22+d[1]+e+%22.jpg%22,0)}else%20if(/metmuseum\.org/.test(g))c(h.innerHTML,/data-superjumboimage=%22(.*%3F)%22/gm,%22%22,%22%22,!0);else%20if(/museoegizio\.it/.test(g))c(h.innerHTML,/Download%20%3Ca%20href=%22(.*%3F)%22/gm,%22%22,%22%22,0);else%20if(/oi-idb\.uchicago\.edu/.test(g))c(h.innerHTML,/cycle-slideshow-image-container%22%20href=%22(.*%3F)%22/gm,%22%22,%22%22,!0);else%20if(/carmentis\.kmkg-mrah\.be/.test(g)){var%20b=/href=%22(.*%3F)%22%20data-fancybox=%22images/gm,l=document.getElementById(%22referenceTab-03%22);if(l.classList.contains(%22referenceTabItem%22)){f=l.getElementsByTagName(%22A%22)[0].getAttribute(%22href%22);var%20m=new%20XMLHttpRequest;m.onreadystatechange=function(){4===m.readyState%26%26200===m.status%26%26m.responseText%26%26c(m.responseText,b,%22%22,%22%22,0)},m.open(%22GET%22,f,!0),m.send(null)}else%20c(h.innerHTML,b,%22%22,%22%22,0)}else%20/harbour\.man\.ac\.uk/.test(g)%3Fc(h.innerHTML,/\%3Firn=(\d*)/gm,%22/emuweb/objects/common/webmedia.php%3Firn=%22,%22%22,0):/bible-orient-museum\.ch/.test(g)%3Fc(h.innerHTML,/background-image:%20url\((.*%3F)\)/gm,%22%22,%22%22,0):/nms.ac\.uk/.test(g)%26%26c(h.innerHTML,/data-zoom-image=%22(.*%3F)%22/gm,%22%22,%22%22,0)}();">
